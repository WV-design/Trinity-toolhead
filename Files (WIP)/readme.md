...
- Want to use a toolhead board ~~To increase the y footprint~~ ? Check out the "extras" section, the files are made for the "Mellow fly sht36 v2" but can be adapted.
